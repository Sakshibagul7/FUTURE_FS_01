                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6 relative z-10">
                        <div className="text-center">
                            <h1 className="text-4xl tracking-tight font-extrabold text-slate-900 sm:text-5xl md:text-6xl">
                                <span className="block">Manage Your Leads.</span>
                                <span className="block text-indigo-600">
                                    Grow Your Business.
                                </span>
                            </h1>
                            <p className="mt-3 max-w-md mx-auto text-base text-slate-600 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                                EngageHub CRM empowers your sales team to streamline their workflow, close more deals, and build lasting customer relationships with style.
                            </p>
